...
# for self SELF 
	move	$a0 $s0 # duplicate
	bne	$a0 $zero label4 # duplicate
	la	$a0 str_const0 # duplicate
	li	$t1 1 # duplicate
	jal	_dispatch_abort # duplicate
label4: # duplicate
	lw	$t1 8($a0) # duplicate
	lw	$t1 8($t1) # duplicate
	jalr	$t1 # duplicate
