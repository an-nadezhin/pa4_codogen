...
Main.main:
 ...
 # let code for name foo
	...
	sw	$a0 20($fp) # main
#  ==> foo offset : 3 Main type:M 
#  ==> foo offset : 4 Main type:M 
#  ==> foo offset : 5 Main type:M 
#  -> curr off 20
# for foo method 
	lw	$a0 20($fp) # main
	lw	$s1 12($a0) # main
